    ...
    "2025": [
        {
            ...
            authors: "Hill, ED., Kashyap, P., Raffanello, E., Wang, Y., Moffitt, TE., Caspi, A., ...",
            journal: "Nature Medicine",
            pages: "1-7",
            doi: "https://doi.org/10.1038/s41591-025-03560-7",
            pdf: null // Add PDF link when available
        }
    ],
    "2024": [
        {
            ...
            authors: "Zhang, X., Wu, Y., Angelini, E., Li, A., Guo, J., Rasmussen, JM., O'Connor, TG., Wang, Y., ...",
        ...
        {
            title: "Reduced dorsal fronto-striatal connectivity at rest in anorexia nervosa",
            authors: "Muratore, AF., Foerde, K., Lloyd, EC., Touzeau, C., Uniacke, B., Aw, N., Wang, Y., ...",
            journal: "Psychological Medicine",
            pages: "54 (9), 2200-2209",
            doi: null,
            pdf: null
        },
        {
            title: "Segmenting hypothalamic subunits in human newborn magnetic resonance imaging data",
            authors: "Rasmussen, JM., Wang, Y., Graham, AM., Fair, DA., Posner, J., O'Connor, TG., ...",
